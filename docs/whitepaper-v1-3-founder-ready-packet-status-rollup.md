...
| 4 | `docs/whitepaper-v1-3-founder-review-state-transition-matrix.md` | confirm local-review, reviewer routing, public, and live states stay separate |
| 5 | `docs/whitepaper-v1-3-publication-blocker-status-matrix.md` | confirm all public/live blockers remain pending or blocked |
| 6 | `docs/whitepaper-v1-3-publication-evidence-current-status.md` | see what local evidence exists and what is still missing |
| 7 | `docs/whitepaper-v1-3-provider-question-status-matrix.md` | review unanswered provider question groups |
| 8 | `docs/whitepaper-v1-3-smartcontractor-wording-review-status.md` | verify SmartContractor wording stays demo-only and provider-reviewed |
| 9 | `docs/whitepaper-v1-3-draft-qa-issue-register.md` | track local draft QA issues before any public use |
