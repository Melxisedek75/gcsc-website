...
7. Run `npm run summarize:kimi-output-intake` to count the saved files and catch obvious secret/live-risk wording before review.
8. Run `npm run audit:kimi-worker-reports` to check required worker report fields, stream mismatches, missing expected reports, and unsafe live/legal/money wording before Claude review.
9. Run `npm run prepare:kimi-merge-queue` to create the dated Codex integration queue before any accepted stream is staged.
10. Give Claude the Claude audit files plus Kimi outputs.
11. Give Codex only Claude-approved local outputs for integration.
...
| 8 | `docs/gcsc-kimi-wave-one-progress-tracker-2026-05-14.md` | shared status board for 100-agent progress, hard stops, Claude verdicts, and Codex intake |
| 9 | `docs/gcsc-kimi-worker-output-package-template-2026-05-14.md` | required worker report structure so Claude/Codex can audit outputs quickly |
| 10 | `docs/gcsc-claude-kimi-audit-report-template-2026-05-14.md` | required Claude audit structure for post-Kimi review |
| 11 | `docs/gcsc-kimi-stream-a-whitepaper-v1-2-public-draft-work-order.md` | Stream A work order |
| 12 | `docs/gcsc-kimi-stream-f-n-api-and-public-safety-work-order.md` | Streams F/N work order |
| 13 | `docs/gcsc-kimi-stream-j-smart-contract-local-build-map-work-order.md` | Stream J work order |
| 14 | `docs/gcsc-kimi-stream-h-auth-rls-admin-work-order.md` | Stream H work order |
| 15 | `docs/gcsc-kimi-stream-i-deployment-public-beta-work-order.md` | Stream I work order |
| 16 | `docs/gcsc-kimi-stream-o-investor-partner-alignment-work-order.md` | Stream O work order |
| 17 | `docs/gcsc-kimi-stream-m-mobile-readiness-work-order.md` | Stream M work order |
| 18 | `docs/gcsc-kimi-stream-k-contract-backed-loan-implementation-work-order.md` | Stream K work order |
| 19 | `docs/gcsc-kimi-stream-l-legal-provider-review-work-order.md` | Stream L work order |
| 20 | `docs/gcsc-kimi-claude-codex-handoff-bundle-manifest-2026-05-14.md` | this bundle manifest for file routing and role ownership |
