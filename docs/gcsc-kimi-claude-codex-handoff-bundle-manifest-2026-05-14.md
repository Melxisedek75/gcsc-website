...
6. Run `npm run print:kimi-latest-launch-paths` if you need the newest generated bundle, founder prompt, prompt folder, manifest files, `agent-assignment.csv`, whitepaper revision controller start-here paths, safe commands, and upload allowlist/blocklist again.
