# SmartContractor Beta Tester Follow-Up

Date: 2026-05-11

## Purpose

This is a simple follow-up message for the first SmartContractor beta testers after a demo-only session. It collects useful feedback without asking for secrets, private identity data, real payment details, or legal/financial commitments.

## Send After

Send this after the tester completes one demo session covering:
...
Subject: SmartContractor beta feedback

Hi [Name],

Thank you for testing the SmartContractor demo.
...
1. Which role did you test: homeowner, contractor, peer reviewer, or admin/risk?
2. Was the homeowner flow clear enough to post a real construction job in the future?
3. Was the contractor bid and simulated starter loan flow understandable?
4. Did the payment simulation clearly feel demo-only, with no real loan, no real escrow, and no production payment?
...
- Follow-up clearly says demo-only.
