...
|--------|------:|---------|
| DONE | 650 | Implemented or documented with local validation |
| REVIEW | 12 | Prepared, but needs founder/legal/live-system review before activation |
| BLOCKED | 3 | Needs founder account, external account, legal/provider action, or paid/controlled setup |
| LATER | 2 | Planned after beta readiness |
| TOTAL | 667 | Current tracked backlog items |

Raw backlog completion by item count: 650 / 667 = about 97%.
...
- Kimi latest launch paths printer via `npm run print:kimi-latest-launch-paths`, printing the newest generated Kimi handoff bundle, founder prompt, prompt folder, manifest files, and `agent-assignment.csv`, with `npm run check:kimi-latest-launch-paths` verifying those paths exist after one-command launch prep.
