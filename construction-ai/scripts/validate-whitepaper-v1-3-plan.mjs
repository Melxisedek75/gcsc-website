...
const fileSpecificPhrases = new Map([
  ...
  ['docs/whitepaper-v1-3-draft-static-asset-manifest.md', ['Draft Static Asset Manifest', 'Draft File Asset Map', 'Blocked Legacy Dependencies', 'Publication Asset Review Still Required', 'PENDING_EXTERNAL_ASSET_REVIEW', 'Stop Boundary']],
  ['docs/whitepaper-v1-3-draft-external-asset-review-intake-checklist.md', ['Draft External Asset Review Intake Checklist', 'Assets In Scope', 'Intake Requirements', 'Allowed Intake States', 'PENDING_EXTERNAL_ASSET_REVIEW', 'Stop Boundary']],
  ['docs/whitepaper-v1-3-draft-print-pdf-export-static-checklist.md', ['Draft Print PDF Export Static Checklist', 'Static Print And Export Checks', 'Future Export Evidence Template', 'PENDING_PRINT_PDF_EXPORT_REVIEW', 'Stop Boundary']],
  ['docs/whitepaper-v1-3-draft-accessibility-static-checklist.md', ['Draft Accessibility Static Checklist', 'Static Checks', 'Manual Checks Still Required', 'PENDING_BROWSER_A11Y_REVIEW', 'Stop Boundary']],
  ['docs/whitepaper-v1-3-draft-responsive-static-checklist.md', ['Draft Responsive Static Checklist', 'Static Checks', 'Manual Checks Still Required', 'PENDING_RESPONSIVE_BROWSER_REVIEW', 'Stop Boundary']],
  ['docs/whitepaper-v1-3-draft-content-parity-checklist.md', ['Draft Content Parity Checklist', 'Static Parity Checks', 'Manual Content Checks Still Required', 'PENDING_BROWSER_CONTENT_REVIEW', 'Stop Boundary']],
  ['docs/whitepaper-v1-3-draft-link-cta-static-checklist.md', ['Draft Link CTA Static Checklist', 'Static Link And CTA Checks', 'Manual Click Checks Still Required', 'PENDING_BROWSER_CLICK_REVIEW', 'PENDING_MOBILE_TAP_REVIEW', 'Stop Boundary']],
  ...
  ['docs/whitepaper-v1-3-public-distribution-boundary-matrix.md', ['Public Distribution Boundary Matrix', 'Distribution Channel Matrix', 'BLOCKED_NO_GO', 'BLOCKED_PROVIDER_OUTREACH', 'Stop Boundary']],
  ['docs/whitepaper-v1-3-founder-publication-readiness-handoff.md', ['Founder Publication Readiness Handoff', 'Current Readiness Snapshot', 'Founder Decisions Available Now', 'Founder Decisions Not Available Yet', 'Evidence Still Required Before Any GO', 'Stop Boundary']],
  ...
  ['docs/whitepaper-v1-3-founder-browser-qa-runbook.md', ['Founder Browser QA Runbook', 'Files To Open', 'Founder Steps', 'Required Evidence IDs', 'Redaction Check', 'Stop Boundary']],
...
['docs/whitepaper-v1-3-smartcontractor-product-integration-map.md', ['SmartContractor Product Integration Map', 'Product Module Map', 'Provider Handoff Packet Shape', 'Product Release Gates', 'BLOCKED_LIVE_ACTIONS', 'Stop Boundary']],
  ...
  ['docs/whitepaper-v1-3-provider-handoff-packet-map.md', ['Provider Handoff Packet Map', 'Packet Map', 'Data Minimization Rules', 'Required Before Any Send', 'BLOCKED_NO_OUTREACH', 'Stop Boundary']],
  ['docs/whitepaper-v1-3-provider-response-intake-template.md', ['Provider Response Intake Template', 'Required Provider Findings', 'Routing Rules', 'NO by default', 'Stop Boundary']],
  ['docs/whitepaper-v1-3-provider-response-routing-checklist.md', ['Provider Response Routing Checklist', 'Required Inputs Before Routing', 'Routing Matrix', 'No-Shortcut Rules', 'Stop Boundary']],
  ['docs/whitepaper-v1-3-provider-response-evidence-log.md', ['Provider Response Evidence Log', 'Evidence Rows Template', 'Allowed Evidence States', 'No-Shortcut Rules', 'Stop Boundary']],
  ['docs/whitepaper-v1-3-provider-response-summary-shell.md', ['Provider Response Summary Shell', 'Provider Decision Summary', 'Required Provider Follow-Up Queue', 'Blockers Carried Forward', 'Stop Boundary']],
  ['docs/whitepaper-v1-3-provider-response-action-queue.md', ['Provider Response Action Queue', 'Current Queue State', 'Action Rows Template', 'QUEUE_NOT_ACTIVE', 'Stop Boundary']],
  ['docs/whitepaper-v1-3-provider-response-decision-register.md', ['Provider Response Decision Register', 'Current Decision State', 'Decision Rows Template', 'NO_DECISION_RECORDED', 'Stop Boundary']],
  ['docs/whitepaper-v1-3-provider-response-decision-evidence-template.md', ['Provider Response Decision Evidence Template', 'Evidence Preconditions', 'Evidence Rows Template', 'Allowed Evidence States', 'Stop Boundary']],
  ['docs/whitepaper-v1-3-provider-response-decision-evidence-intake.md', ['Provider Response Decision Evidence Intake', 'Intake Preconditions', 'Intake Record Template', 'Intake Routing Rules', 'Stop Boundary']],
  ['docs/whitepaper-v1-3-provider-response-decision-evidence-summary.md', ['Provider Response Decision Evidence Summary', 'Summary Preconditions', 'Summary Record Template', 'Summary Routing Rules', 'Stop Boundary']],
  ['docs/whitepaper-v1-3-provider-response-decision-evidence-closeout.md', ['Provider Response Decision Evidence Closeout', 'Closeout Preconditions', 'Closeout Record Template', 'Closeout Routing Rules', 'Stop Boundary']],
  ['docs/whitepaper-v1-3-provider-response-decision-evidence-archive.md', ['Provider Response Decision Evidence Archive', 'Archive Preconditions', 'Archive Record Template', 'Archive Routing Rules', 'Stop Boundary']],
  ['docs/whitepaper-v1-3-provider-response-decision-evidence-archive-index.md', ['Provider Response Decision Evidence Archive Index', 'Archive Index Preconditions', 'Archive Index Record Template', 'Archive Index Routing Rules', 'Stop Boundary']],
  ['docs/whitepaper-v1-3-provider-response-decision-evidence-archive-index-closeout.md', ['Provider Response Decision Evidence Archive Index Closeout', 'Archive Index Closeout Preconditions', 'Archive Index Closeout Record Template', 'Archive Index Closeout Routing Rules', 'Stop Boundary']],
  ['docs/whitepaper-v1-3-provider-response-decision-evidence-archive-handoff.md', ['Provider Response Decision Evidence Archive Handoff', 'Archive Handoff Preconditions', 'Archive Handoff Record Template', 'Archive Handoff Routing Rules', 'Stop Boundary']],
  ['docs/whitepaper-v1-3-provider-response-decision-evidence-archive-handoff-closeout.md', ['Provider Response Decision Evidence Archive Handoff Closeout', 'Archive Handoff Closeout Preconditions', 'Archive Handoff Closeout Record Template', 'Archive Handoff Closeout Routing Rules', 'Stop Boundary']],
  ['docs/whitepaper-v1-3-provider-response-decision-evidence-archive-external-record-request.md', ['Provider Response Decision Evidence Archive External Record Request', 'External Record Request Preconditions', 'External Record Request Template', 'External Record Request Routing Rules', 'Stop Boundary']],
  ...
  ['docs/whitepaper-v1-3-reviewer-packet-send-readiness-checklist.md', ['Reviewer Packet Send Readiness Checklist', 'Reviewer Packet Send Readiness Checks', 'PENDING_FOUNDER_SEND_DECISION', 'BLOCKED_NO_SEND', 'Stop Boundary']],
  ...
  ['docs/whitepaper-v1-3-reviewer-response-change-request-queue.md', ['Reviewer Response Change Request Queue', 'Current Queue State', 'Change Request Rows Template', 'QUEUE_NOT_ACTIVE', 'Stop Boundary']],
  ['docs/whitepaper-v1-3-reviewer-response-re-review-checklist.md', ['Reviewer Response Re-Review Checklist', 'Current Re-Review State', 'Required Before Re-Review', 'REREVIEW_NOT_READY', 'Stop Boundary']],
['docs/whitepaper-v1-3-reviewer-response-local-revision-evidence-log.md', ['Reviewer Response Local Revision Evidence Log', 'Current Evidence State', 'Evidence Rows Template', 'REVISION_EVIDENCE_NOT_RECORDED', 'Stop Boundary']],
['docs/whitepaper-v1-3-reviewer-response-draft-qa-routing-gate.md', ['Reviewer Response Draft QA Routing Gate', 'Current Gate State', 'Required Routing Sequence', 'DRAFT_QA_ROUTING_NOT_ACTIVE', 'Stop Boundary']],
...
['docs/whitepaper-v1-3-public-wording-scan-evidence-log.md', ['Public Wording Scan Evidence Log', 'Current Scan State', 'Scan Evidence Rows', 'LEGACY_SCAN_ONLY', 'Stop Boundary']],
