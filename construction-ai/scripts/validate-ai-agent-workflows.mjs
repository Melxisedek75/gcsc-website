...
assertIncludes(smoke, 'workflow_supported_fact_sets: catalogWorkflowSupportedFactCount', smokePath);
assertIncludes(smoke, 'workflow_blocked_action_sets: catalogWorkflowBlockedActionCount', smokePath);
