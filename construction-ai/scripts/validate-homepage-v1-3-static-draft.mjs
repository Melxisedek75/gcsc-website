...
for (const phrase of [
  ...
  'Traditional Product Review Order',
  'Homeowner project request',
  'Contractor profile and verification readiness',
  'Bid records and project contract records',
  'Milestone evidence and approval readiness',
  'Dispute evidence and peer review',
  'Contractor reputation and completion history',
  'Working-capital readiness packet for future provider review',
  'Admin audit trail and request IDs',
  'Future reviewed infrastructure layer',
  'Integration Readiness Ports',
