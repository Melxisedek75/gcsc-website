...
for (const phrase of [
  ...
  'provider response intake | READY_LOCAL_TEMPLATE_PENDING_PROVIDER_RESPONSE',
  ...
  'provider response summary shell | READY_LOCAL_SHELL_PENDING_PROVIDER_RESPONSE',
  'provider response summary shell | PENDING_PROVIDER_RESPONSE',
  'provider response action queue | READY_LOCAL_QUEUE_PENDING_PROVIDER_RESPONSE',
  ...
  'provider response decision evidence intake | READY_LOCAL_TEMPLATE_PENDING_PROVIDER_RESPONSE',
  'provider response decision evidence intake | PENDING_PROVIDER_RESPONSE',
  ...
  'reviewer response re-review checklist | READY_LOCAL_CHECKLIST_PENDING_RESPONSE_INTAKE',
  'reviewer response re-review checklist | PENDING_RESPONSE_INTAKE',
  'reviewer response local revision evidence log | READY_LOCAL_LOG_PENDING_RESPONSE_INTAKE',
  'reviewer response local revision evidence log | PENDING_RESPONSE_INTAKE',
  'reviewer response draft QA routing gate | READY_LOCAL_GATE_PENDING_RESPONSE_INTAKE',
...
requirePhrase(reReviewChecklist, 'No re-review packet is ready', 'reviewer response re-review checklist');
...
requirePhrase(providerResponseActionQueue, 'Provider Response Action Queue', 'provider response action queue');
