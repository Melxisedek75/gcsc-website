...
for (const required of [
  ...
  'investor_package_final_handoff_state',
  'READY_FOR_FOUNDER_PACKET_DRAFT, NEEDS_AUDIENCE_CLARIFICATION, HOLD_FOR_CLAIM_REVIEW, HOLD_FOR_REDACTION_REVIEW, HOLD_FOR_LEGAL_PROVIDER_REVIEW, HOLD_FOR_TRACTION_EVIDENCE_REVIEW, or NO_GO',
  'investor_package_final_handoff_evidence',
