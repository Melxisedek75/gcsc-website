...
for (const snippet of [
  ...
  'Export guard',
  'tester_artifact_purge_policy',
  'Purge policy',
  'tester_artifact_retention_clock',
  'Retention clock',
  'tester_artifact_disposal_ledger',
  'Disposal ledger row',
  'tester_artifact_access_roles',
  'Access roles',
  'tester_artifact_chain_of_custody',
  'Chain of custody',
  'tester_artifact_public_summary_rules',
  'Public summary rules',
  'tester_artifact_anonymization_checklist',
  'Anonymization checklist',
  'tester_artifact_approval_stamp',
  'Approval stamp',
  'tester_artifact_revocation_rules',
  'Revocation rules',
  'tester_artifact_external_packet_manifest',
  'External packet manifest',
  'tester_artifact_external_packet_distribution_log',
  'Distribution log',
  'tester_artifact_external_packet_recall_checklist',
  'Recall checklist',
  'tester_artifact_external_packet_correction_notice',
  'Correction notice',
  'tester_artifact_external_packet_version_history',
  'Version history',
  'tester_artifact_external_packet_claim_review',
  'Claim review',
  'tester_artifact_external_packet_audience_review',
  'Audience review',
  'review_packet',
