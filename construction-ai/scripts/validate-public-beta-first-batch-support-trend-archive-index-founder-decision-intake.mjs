...
assertIncludes(context, 'Backlog count at latest audit: 923 tracked items, 906 DONE, 12 REVIEW, 3 BLOCKED, 2 LATER.', contextPath);
...
assertIncludes(audit, '| DONE | 906 |', auditPath);
assertIncludes(audit, '| TOTAL | 923 |', auditPath);
assertIncludes(audit, '906 / 923', auditPath);
