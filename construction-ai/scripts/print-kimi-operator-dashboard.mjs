...
const latestPaths = {
  ...
  whitepaper_revision_controller_start_here: optionalPath(latestWhitepaperRevisionPrompts && resolve(latestWhitepaperRevisionPrompts.path, 'CONTROLLER-START-HERE.txt')),
