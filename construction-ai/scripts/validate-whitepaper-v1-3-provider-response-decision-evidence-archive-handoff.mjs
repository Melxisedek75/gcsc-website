...
[
  'Provider Response Decision Evidence Archive Handoff',
  'Status: internal provider-response decision evidence archive handoff',
  'No provider response decision evidence archive handoff is recorded yet',
  'Archive Handoff Preconditions',
  'Archive Handoff Record Template',
  ...
  'V13-PD-EVID-001',
  'V13-PD-001',
  'Required Archive Handoff Findings',
  'Archive Handoff Routing Rules',
  'Safe Archive Handoff Rules',
  'Cross References',
  'No-Shortcut Rules',
...
].forEach((phrase) => requirePhrase(archiveHandoff, phrase, 'provider response decision evidence archive handoff'));
...
[
  ...
  'attorney reviewer',
].forEach((category) => requirePhrase(archiveHandoff, category, 'provider response decision evidence archive handoff'));
...
].forEach((fileReference) => requirePhrase(archiveHandoff, fileReference, 'provider response decision evidence archive handoff'));

requirePhrase(archiveIndexCloseout, 'Provider Response Decision Evidence Archive Index Closeout', 'provider response decision evidence archive index closeout');
requirePhrase(archiveIndexCloseout, 'No provider response decision evidence archive index closeout is recorded yet', 'provider response decision evidence archive index closeout');
requirePhrase(archiveIndexCloseout, 'docs/whitepaper-v1-3-provider-response-decision-evidence-archive-handoff.md', 'provider response decision evidence archive index closeout');
...
requirePhrase(archiveIndex, 'docs/whitepaper-v1-3-provider-response-decision-evidence-archive-handoff.md', 'provider response decision evidence archive index');
...
requirePhrase(decisionEvidenceArchive, 'docs/whitepaper-v1-3-provider-response-decision-evidence-archive-handoff.md', 'provider response decision evidence archive');
...
requirePhrase(decisionEvidenceCloseout, 'docs/whitepaper-v1-3-provider-response-decision-evidence-archive-handoff.md', 'provider response decision evidence closeout');
...
requirePhrase(decisionEvidenceSummary, 'docs/whitepaper-v1-3-provider-response-decision-evidence-archive-handoff.md', 'provider response decision evidence summary');
...
requirePhrase(decisionEvidenceIntake, 'docs/whitepaper-v1-3-provider-response-decision-evidence-archive-handoff.md', 'provider response decision evidence intake');
...
requirePhrase(decisionEvidenceTemplate, 'docs/whitepaper-v1-3-provider-response-decision-evidence-archive-handoff.md', 'provider response decision evidence template');
...
requirePhrase(decisionRegister, 'docs/whitepaper-v1-3-provider-response-decision-evidence-archive-handoff.md', 'provider response decision register');
...
requirePhrase(intake, 'docs/whitepaper-v1-3-provider-response-decision-evidence-archive-handoff.md', 'provider response intake template');
...
requirePhrase(routing, 'docs/whitepaper-v1-3-provider-response-decision-evidence-archive-handoff.md', 'provider response routing checklist');
...
requirePhrase(evidenceLog, 'docs/whitepaper-v1-3-provider-response-decision-evidence-archive-handoff.md', 'provider response evidence log');
...
requirePhrase(summaryShell, 'docs/whitepaper-v1-3-provider-response-decision-evidence-archive-handoff.md', 'provider response summary shell');
...
requirePhrase(actionQueue, 'docs/whitepaper-v1-3-provider-response-decision-evidence-archive-handoff.md', 'provider response action queue');
requirePhrase(publicationStatus, 'provider response decision evidence archive handoff | PENDING_PROVIDER_RESPONSE', 'publication evidence current status');
requirePhrase(founderReadyRollup, 'provider response decision evidence archive handoff | PENDING_PROVIDER_RESPONSE', 'founder-ready packet status rollup');
requirePhrase(masterIndex, 'provider response decision evidence archive handoff | local decision evidence archive handoff only / no provider response decision evidence archive handoff recorded', 'internal review master index');
...
[
  /\bprovider response decision evidence archive handoff recorded\b/i,
...
].forEach((pattern) => rejectPattern(archiveHandoff, pattern, 'provider response decision evidence archive handoff'));

for (const [content, label] of [
  [publicWhitepaper, 'public whitepaper'],
  [publicHomepage, 'public homepage'],
]) {
  if (content.includes('Provider Response Decision Evidence Archive Handoff') || content.includes('V13-PD-EVID-ARCH-HANDOFF-001')) {
    errors.push(`${label} appears to contain internal provider response decision evidence archive handoff content`);
  }
}

if (errors.length > 0) {
  console.error('whitepaper v1.3 provider response decision evidence archive handoff validation failed:');
  errors.forEach((error) => console.error(`- ${error}`));
  process.exit(1);
}

console.log('whitepaper v1.3 provider response decision evidence archive handoff validation passed');
