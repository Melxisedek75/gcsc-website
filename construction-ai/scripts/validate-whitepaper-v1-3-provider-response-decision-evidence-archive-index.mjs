...
const files = {
  decisionEvidenceArchiveIndex: path.join(root, 'docs', 'whitepaper-v1-3-provider-response-decision-evidence-archive-index.md'),
...
const decisionEvidenceArchiveIndex = readRequired('provider response decision evidence archive index', files.decisionEvidenceArchiveIndex);
...
[
  ...
  'Status: internal provider-response decision evidence archive index',
  'No provider response decision evidence archive index is active yet',
...
].forEach((phrase) => requirePhrase(decisionEvidenceArchiveIndex, phrase, 'provider response decision evidence archive index'));
...
[
  ...
  'attorney reviewer',
].forEach((category) => requirePhrase(decisionEvidenceArchiveIndex, category, 'provider response decision evidence archive index'));
...
].forEach((fileReference) => requirePhrase(decisionEvidenceArchiveIndex, fileReference, 'provider response decision evidence archive index'));
...
requirePhrase(decisionEvidenceArchive, 'docs/whitepaper-v1-3-provider-response-decision-evidence-archive-index.md', 'provider response decision evidence archive');
...
requirePhrase(decisionEvidenceCloseout, 'docs/whitepaper-v1-3-provider-response-decision-evidence-archive-index.md', 'provider response decision evidence closeout');
...
requirePhrase(decisionEvidenceSummary, 'docs/whitepaper-v1-3-provider-response-decision-evidence-archive-index.md', 'provider response decision evidence summary');
...
requirePhrase(decisionEvidenceIntake, 'docs/whitepaper-v1-3-provider-response-decision-evidence-archive-index.md', 'provider response decision evidence intake');
...
requirePhrase(decisionEvidenceTemplate, 'docs/whitepaper-v1-3-provider-response-decision-evidence-archive-index.md', 'provider response decision evidence template');
...
requirePhrase(decisionRegister, 'docs/whitepaper-v1-3-provider-response-decision-evidence-archive-index.md', 'provider response decision register');
...
requirePhrase(intake, 'docs/whitepaper-v1-3-provider-response-decision-evidence-archive-index.md', 'provider response intake template');
...
requirePhrase(routing, 'docs/whitepaper-v1-3-provider-response-decision-evidence-archive-index.md', 'provider response routing checklist');
...
requirePhrase(evidenceLog, 'docs/whitepaper-v1-3-provider-response-decision-evidence-archive-index.md', 'provider response evidence log');
...
requirePhrase(summaryShell, 'docs/whitepaper-v1-3-provider-response-decision-evidence-archive-index.md', 'provider response summary shell');
...
requirePhrase(actionQueue, 'docs/whitepaper-v1-3-provider-response-decision-evidence-archive-index.md', 'provider response action queue');
requirePhrase(publicationStatus, 'provider response decision evidence archive index | PENDING_PROVIDER_RESPONSE', 'publication evidence current status');
requirePhrase(founderReadyRollup, 'provider response decision evidence archive index | PENDING_PROVIDER_RESPONSE', 'founder-ready packet status rollup');
requirePhrase(masterIndex, 'provider response decision evidence archive index | local decision evidence archive index only / no provider response decision evidence archive index active', 'internal review master index');
...
[
  /\bprovider response decision evidence archive index active\b/i,
...
].forEach((pattern) => rejectPattern(decisionEvidenceArchiveIndex, pattern, 'provider response decision evidence archive index'));

for (const [content, label] of [
  [publicWhitepaper, 'public whitepaper'],
  [publicHomepage, 'public homepage'],
]) {
  if (content.includes('Provider Response Decision Evidence Archive Index') || content.includes('V13-PD-EVID-ARCH-IDX-001')) {
    errors.push(`${label} appears to contain internal provider response decision evidence archive index content`);
  }
}

if (errors.length > 0) {
  console.error('whitepaper v1.3 provider response decision evidence archive index validation failed:');
  errors.forEach((error) => console.error(`- ${error}`));
  process.exit(1);
}

console.log('whitepaper v1.3 provider response decision evidence archive index validation passed');
