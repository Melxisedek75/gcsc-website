  ...
  const homepagePublicationEvidenceChecklist = [
    {
      ...
      evidence_state: 'PENDING_CAPTURE',
      ...
      current_blocker: 'Local browser evidence is not captured yet; prior local URL attempt returned 404 and must be retried locally.',
      next_safe_action: 'Run local-only browser QA against index-v1-3-draft.html and record evidence before considering PUBLICATION_GO.',
    ...
    },
    {
      ...
      current_blocker: 'External asset posture must be reviewed before publishing the replacement homepage.',
      next_safe_action: 'Record whether the approved candidate can use external CDN/fonts or needs a local/static fallback.',
      evidence_source: 'docs/smartcontractor-public-homepage-visual-qa-rollback-checklist-2026-06-03.md',
      no_public_homepage_edit_attempted: true,
      no_public_whitepaper_edit_attempted: true,
      no_deploy_setting_change_attempted: true,
      no_public_url_share_attempted: true,
    ...
    },
    {
      ...
      current_blocker: 'Archive and rollback owner/path are not final approval evidence yet.',
      next_safe_action: 'Prepare a non-destructive rollback path before any public file replacement.',
      evidence_source: 'docs/smartcontractor-public-homepage-visual-qa-rollback-checklist-2026-06-03.md',
      no_public_homepage_edit_attempted: true,
      no_public_whitepaper_edit_attempted: true,
      no_deploy_setting_change_attempted: true,
    ...
    },
    {
      ...
      evidence_state: 'PENDING_FINAL_APPROVAL',
      required_before: 'PUBLICATION_GO',
      required_evidence: [
