...
function founderAuthNextStepReadinessItems() {
  return [
    {
...
function weekTwoDeploymentPublicBetaReadinessItems() {
  const commonBlockedLiveActions = [
    'vercel_import',
    'github_pages_setting_change',
    'dns_change',
  ...
  const commonSafetyFlags = {
    no_secret_requested: true,
    no_external_account_login_attempted: true,
    no_external_account_change_attempted: true,
    no_deploy_setting_change_attempted: true,
    no_dns_change_attempted: true,
    no_supabase_redirect_change_attempted: true,
  ...
  return [
    {
      id: 'week_two_deploy_target_review_checklist',
      label: 'Week 2 deploy target review checklist',
      checklist_phase: 'deploy_target_review',
      readiness_state: 'FOUNDER_DEPLOY_TARGET_REVIEW_REQUIRED',
      owner: 'Founder + Codex-local',
      required_evidence: [
        'deployment target label: Vercel, GitHub Pages, local-only hold, or other founder-owned host',
        'app root and build scope: construction-ai app versus static public site',
        'rollback owner and hold decision recorded before any public URL sharing',
        'latest local check set and deployed-commit candidate recorded without external account session data',
      ],
      founder_report_fields: [
      ...
      next_safe_action:
        'Review deploy target ownership and build scope locally; stop before Vercel import, GitHub Pages settings, DNS, Namecheap, production env values, Supabase redirects, or deploy execution.',
      evidence_source: 'docs/smartcontractor-deployment-decision-prep.md',
      blocked_live_actions: commonBlockedLiveActions,
      ...commonSafetyFlags,
    },
    {
      id: 'week_two_public_url_smoke_template_checklist',
      label: 'Week 2 public URL smoke template checklist',
      checklist_phase: 'public_url_smoke_template',
      readiness_state: 'PUBLIC_URL_SMOKE_TEMPLATE_READY_URL_PENDING',
      owner: 'Founder + Codex-local',
      required_evidence: [
        'redacted public URL label only; no real public URL in repo, docs, or chat',
        'deployed commit label, environment label, /api/health status, and request ID',
        'no-real-money banner, security headers, Auth redirect status, and disabled finance evidence',
        'rollback-or-hold decision before public URL sharing or tester invite review',
      ],
      founder_report_fields: [
      ...
      next_safe_action:
        'Keep the smoke template ready for founder-controlled deployment evidence; do not store real public URLs, share URLs, invite testers, or launch public beta.',
      evidence_source: 'docs/smartcontractor-public-beta-url-smoke-evidence-intake.md',
      blocked_live_actions: commonBlockedLiveActions,
      ...commonSafetyFlags,
    },
    {
      id: 'week_two_supabase_redirect_env_boundary_checklist',
      label: 'Week 2 Supabase redirect/env boundary checklist',
      checklist_phase: 'supabase_redirect_env_boundary',
      readiness_state: 'SUPABASE_REDIRECT_ENV_FOUNDER_ONLY_BLOCKED',
      owner: 'Founder',
      required_evidence: [
        'Auth redirect path owner identified without Magic Link URL, token, cookie, or raw env value',
        'public browser env owner and server-only secret owner recorded as roles only',
        'service-role key and provider secrets remain out of repo, docs, chat, and export previews',
        'Supabase redirect update remains founder-only and blocked until deploy URL smoke evidence exists',
      ],
      founder_report_fields: [
        'auth_redirect_path_owner',
        'public_env_owner',
        'server_secret_owner',
        'supabase_redirect_status',
        'no_raw_env_values_confirmation',
      ],
      linked_surfaces: [
        '/api/admin/deployment-next-step-readiness',
        'docs/smartcontractor-deployment-founder-env-map.md',
      ...
      next_safe_action:
        'Prepare only owner labels and placeholder names; founder changes Supabase redirects and environment values directly after separate approval.',
      evidence_source: 'docs/smartcontractor-deployment-founder-env-map.md',
      blocked_live_actions: commonBlockedLiveActions,
      ...commonSafetyFlags,
    },
    {
      id: 'week_two_public_beta_invite_gate_checklist',
      label: 'Week 2 public beta invite gate checklist',
      checklist_phase: 'public_beta_invite_gate',
      readiness_state: 'PUBLIC_BETA_INVITE_APPROVAL_BLOCKED',
      owner: 'Founder',
      required_evidence: [
        'no-real-money scope and disabled finance/escrow/token-collateral evidence reviewed',
        'invite batch size, tester role list, support owner, and issue triage owner recorded',
        'public URL smoke evidence complete before any invite/share decision',
        'separate founder approval for URL sharing and tester invites recorded outside this local checklist',
      ],
      founder_report_fields: [
        'no_real_money_scope_status',
        'invite_batch_size',
        'support_owner',
        'issue_triage_owner',
      ...
      next_safe_action:
        'Keep invite/share review blocked until founder-controlled smoke evidence and a separate invite/share approval exist; do not send invites or flip public beta.',
...
function weekTwoInvestorFounderPackageAlignmentItems() {
  const commonBlockedLiveActions = [
    'investor_outreach',
    'grant_submission',
    'partner_outreach',
    ...
    'xpr_signature',
    'fio_registration',
    'metallicus_partnership_claim',
    'approved_provider_claim',
    'ai_credit_approval_claim',
    'ai_legal_decision_claim',
    'legal_conclusion',
    'provider_commitment',
    'production_release',
  ];
  const commonSafetyFlags = {
    no_secret_requested: true,
    no_external_send_attempted: true,
    no_investor_outreach_attempted: true,
    no_grant_submission_attempted: true,
  ...
  return [
    {
      id: 'week_two_investor_live_finance_claim_alignment',
      label: 'Week 2 investor live-finance claim alignment',
      alignment_area: 'live_finance_claims',
      alignment_state: 'LIVE_FINANCE_CLAIMS_REVIEW_REQUIRED',
      owner: 'Founder/legal/provider + Codex-local',
      required_evidence: [
        'current investor/founder package source ID',
        'no-live-loan, no-real-payment, no-real-escrow, and no-stablecoin-settlement scan result',
        'demo-only finance boundary source',
        'legal/provider review gate source',
      ],
      founder_report_fields: [
        'alignment_area',
        'alignment_state',
      ...
      blocked_claims: [
        'live_loan_available',
        'real_payment_ready',
        'licensed_escrow_ready',
        'stablecoin_settlement_live',
        'repayment_routing_approved',
        'working_capital_funding_ready',
      ],
      next_safe_action:
        'Compare investor/founder package finance wording against local no-real-money gates and mark risky live-finance claims for founder/legal/provider review only.',
      evidence_source: 'docs/smartcontractor-investor-founder-package.md',
      ...commonSafetyFlags,
      blocked_live_actions: commonBlockedLiveActions,
    },
    {
      id: 'week_two_investor_escrow_token_claim_alignment',
      label: 'Week 2 investor escrow/token claim alignment',
      alignment_area: 'escrow_token_claims',
      alignment_state: 'ESCROW_TOKEN_CLAIMS_REVIEW_REQUIRED',
      owner: 'Founder/legal/provider/security + Codex-local',
      required_evidence: [
        'escrow/payment provider review gate source',
        'token collateral and custody review gate source',
        'XPR/FIO/Metallicus candidate-only wording scan',
        'public blockchain/Web3/token claim hidden-or-founder-review-only confirmation',
      ],
      founder_report_fields: [
        'alignment_area',
        'alignment_state',
      ...
      blocked_claims: [
        'licensed_escrow_approved',
        'token_collateral_live',
        'token_custody_ready',
        'xpr_signature_ready',
        'fio_registration_ready',
        'metallicus_partnership_secured',
        'approved_provider_claim',
      ],
      next_safe_action:
        'Keep escrow, token collateral, XPR, FIO, Metallicus, and provider wording candidate-only or founder-review-only until legal/provider/security review clears it.',
      evidence_source: 'docs/whitepaper-v1-3-claim-risk-register.md',
      ...commonSafetyFlags,
      blocked_live_actions: commonBlockedLiveActions,
    },
    {
      id: 'week_two_investor_ai_authority_claim_alignment',
      label: 'Week 2 investor AI authority claim alignment',
      alignment_area: 'ai_authority_claims',
      alignment_state: 'AI_AUTHORITY_CLAIMS_REVIEW_REQUIRED',
      owner: 'Founder/product/legal + Codex-local',
      required_evidence: [
        'AI agent wording scan for recommendation-only framing',
        'credit, compliance, provider, legal, and funding authority blocked-claim list',
        'local request-id/admin evidence boundary source',
        'safe replacement wording for AI evidence sorting and review support',
      ],
      founder_report_fields: [
        'alignment_area',
        'alignment_state',
      ...
      linked_surfaces: [
        '/api/admin/beta-readiness',
        '/api/admin/founder-action-center',
      ...
      blocked_claims: [
        ...
        'ai_compliance_certification',
        'ai_funding_approval',
        'autonomous_live_finance_authority',
      ],
      next_safe_action:
        'Frame AI as local recommendation, routing, evidence sorting, and request-id support only; route authority claims to founder/legal/provider review.',
      evidence_source: 'docs/smartcontractor-real-status-audit-2026-05-16.md',
      ...commonSafetyFlags,
      blocked_live_actions: commonBlockedLiveActions,
    },
    {
      id: 'week_two_investor_external_send_stop_gate',
      label: 'Week 2 investor external-send stop gate',
      alignment_area: 'external_send_stop_gate',
      alignment_state: 'EXTERNAL_SEND_APPROVAL_BLOCKED',
      owner: 'Founder',
      required_phrase: 'INVESTOR_PACKET_SEND_ACTION_RECORDED',
      required_evidence: [
        'audience category',
        'packet version',
        'source commit',
        'latest local check run',
        'claim review status',
        'redaction status',
        'founder-controlled send decision outside Codex',
      ],
      founder_report_fields: [
        'required_phrase',
        'audience_category',
      ...
      linked_surfaces: [
        '/api/admin/admin-evidence-export-preview?source_filter=investor_founder_package_readiness',
        '/api/admin/request-trace-report/validate',
        'docs/smartcontractor-investor-founder-package.md',
      ...
      blocked_claims: [
        ...
        'provider_outreach_approval',
        'attorney_outreach_approval',
      ...
      next_safe_action:
        'Keep all investor, grant, provider, attorney, deck, PDF, email, social, public URL, and public claim sharing blocked until founder handles the exact external-send action outside Codex.',
      evidence_source: 'docs/smartcontractor-investor-founder-package.md',
      ...commonSafetyFlags,
      blocked_live_actions: commonBlockedLiveActions,
    },
...
app.get('/api/admin/founder-auth-next-step-readiness', (req, res) => {
  const items = founderAuthNextStepReadinessItems();
  ...
  res.json({
    generated_at: new Date().toISOString(),
    request_id: req.id || null,
    mode: 'founder_auth_next_step_readiness',
    ...
    items,
    safe_report_fields: [
      'magic_link_email_received_yes_no',
      'same_browser_magic_link_opened_yes_no',
      'founder_auth_setup_clicked_yes_no',
      'founder_auth_setup_request_id',
      'authenticated_yes_no',
      'profile_linked_yes_no',
      'selected_user_confirmed_yes_no_not_shown',
      'visible_admin_role_state',
      'no_secret_confirmation',
    ],
    next_safe_steps: [
      'Use this endpoint to review local Auth/Admin next-step readiness before founder-present Magic Link evidence intake.',
      'Record request IDs and yes/no/not-shown status only; do not paste Magic Link URLs, tokens, service-role keys, raw env values, private IDs, screenshots, payment data, or wallet data.',
      'Stop before profile repair writes, admin_memberships insert/update, strict RLS apply, deploy setting changes, public beta flips, real finance actions, legal/provider decisions, XPR signatures, or production release.',
    ],
...
app.get('/api/admin/deployment-next-step-readiness', (req, res) => {
  const items = deploymentNextStepReadinessItems();
  const stateCounts = groupByStatus(items, 'readiness_state');
  const blockedLiveActions = [...new Set(items.flatMap((item) => item.blocked_live_actions || []))].sort();
  const requiredEvidenceCount = items.reduce(
    (count, item) => count + (Array.isArray(item.required_evidence) ? item.required_evidence.length : 0),
  ...
  res.json({
    generated_at: new Date().toISOString(),
    request_id: req.id || null,
    mode: 'deployment_next_step_readiness',
    status: 'blocked_for_external_account_or_public_release',
    item_count: items.length,
    readiness_state_counts: stateCounts,
    required_evidence_count: requiredEvidenceCount,
    blocked_live_action_count: blockedLiveActions.length,
    ...
    next_safe_steps: [
      'Use this endpoint to review deployment next-step readiness before founder-controlled Vercel, GitHub Pages, DNS, Supabase redirect, public URL, or tester-invite work.',
      'Record only host choice, owner, local check result, redacted URL label, Auth redirect status, request ID, and rollback-or-hold decision.',
      'Stop before external account login, Vercel import, GitHub Pages setting change, DNS/Namecheap change, production env value entry, Supabase redirect update, public URL sharing, tester invites, real finance actions, legal/provider decisions, XPR signatures, or production release.',
    ],
    blocked_live_actions: blockedLiveActions,
    no_external_account_login_attempted: true,
    no_external_account_change_attempted: true,
...
app.get('/api/admin/week-two-deployment-public-beta-readiness', (req, res) => {
  const items = weekTwoDeploymentPublicBetaReadinessItems();
  const stateCounts = groupByStatus(items, 'readiness_state');
  const phaseCounts = groupByStatus(items, 'checklist_phase');
  const blockedLiveActions = [...new Set(items.flatMap((item) => item.blocked_live_actions || []))].sort();
  const requiredEvidenceCount = items.reduce(
  ...
  res.json({
    generated_at: new Date().toISOString(),
    request_id: req.id || null,
    mode: 'week_two_deployment_public_beta_readiness',
    status: 'blocked_for_founder_deploy_public_beta_actions',
    item_count: items.length,
    readiness_state_counts: stateCounts,
    checklist_phase_counts: phaseCounts,
    required_evidence_count: requiredEvidenceCount,
    ...
    next_safe_steps: [
      'Use this endpoint as the Week 2 deployment/public beta checklist before founder-controlled external account, deploy, Supabase redirect, URL smoke, or invite decisions.',
      'Record only target labels, owner roles, local check names, redacted URL labels, request IDs, smoke statuses, invite scope, support/triage owners, and rollback-or-hold status.',
      'Stop before external account login, Vercel import, GitHub Pages setting change, DNS/Namecheap change, production env value entry, Supabase redirect update, real public URL storage, public URL sharing, tester invites, public beta flip, finance actions, legal/provider decisions, XPR signatures, or production release.',
    ],
    blocked_live_actions: blockedLiveActions,
    no_secret_requested: true,
    no_external_account_login_attempted: true,
...
app.get('/api/admin/week-two-investor-founder-package-alignment', (req, res) => {
  const items = weekTwoInvestorFounderPackageAlignmentItems();
  const alignmentStateCounts = groupByStatus(items, 'alignment_state');
  const alignmentAreaCounts = groupByStatus(items, 'alignment_area');
  const blockedLiveActions = [...new Set(items.flatMap((item) => item.blocked_live_actions || []))].sort();
  const requiredEvidenceCount = items.reduce(
    (count, item) => count + (Array.isArray(item.required_evidence) ? item.required_evidence.length : 0),
    0
  ...
  res.json({
    generated_at: new Date().toISOString(),
    request_id: req.id || null,
    mode: 'week_two_investor_founder_package_alignment',
    status: 'blocked_until_founder_external_sharing_review',
    item_count: items.length,
    alignment_state_counts: alignmentStateCounts,
    alignment_area_counts: alignmentAreaCounts,
    required_evidence_count: requiredEvidenceCount,
    founder_report_field_count: founderReportFieldCount,
    linked_surfaces: linkedSurfaces,
    blocked_live_action_count: blockedLiveActions.length,
    ...
    next_safe_steps: [
      'Use this endpoint as a Week 2 investor/founder packet alignment scan before any investor, grant, provider, attorney, deck, PDF, email, social, or public URL action.',
      'Record only alignment area/state, package source ID, blocked claim category, safe replacement summary, owner, source commit, local check status, redaction status, and blocked next action.',
      'Stop before external sends, investor outreach, grant submissions, provider or attorney outreach, public claim approvals, live finance claims, real payments, real loans, real escrow, stablecoin settlement, token collateral, token custody, XPR signatures, FIO registration, Metallicus/provider approval claims, AI authority claims, legal/provider decisions, or production release.',
    ],
    blocked_live_actions: blockedLiveActions,
    no_secret_requested: true,
    no_external_send_attempted: true,
...
function buildAdminEvidenceExportPreview(req) {
  ...
  const reviewTargetBySource = {
    ...
    week_two_deployment_public_beta_readiness: {
      id: 'week_two_deployment_public_beta_readiness_target',
      source_id: 'week_two_deployment_public_beta_readiness',
      title: 'Week 2 deployment/public beta readiness',
      ui_anchor: 'betaReadinessGrid',
      local_check: 'npm run check:auth',
      next_review_action: 'Review Week 2 deploy target, public URL smoke template, Supabase redirect/env owner, and invite gate metadata before founder deployment/public beta decisions.',
      safe_review_router: 'local_ui_navigation_only',
      no_server_storage_attempted: true,
      no_external_export_attempted: true,
      no_live_action_attempted: true,
    },
    legal_provider_next_step_readiness: {
      id: 'legal_provider_next_step_readiness_target',
      source_id: 'legal_provider_next_step_readiness',
      title: 'Legal/provider next-step readiness',
      ui_anchor: 'betaReadinessGrid',
      local_check: 'npm run check:auth',
      next_review_action:
        'Review working-capital, escrow/payment, ClaimBridge/advance, token-collateral question prep, evidence sources, and no-legal/no-provider/no-finance/no-XPR/no-live-action blocker metadata before external legal/provider review.',
      safe_review_router: 'local_ui_navigation_only',
      no_server_storage_attempted: true,
      no_external_export_attempted: true,
      no_live_action_attempted: true,
    ...
    public_beta_next_step_readiness: {
      ...
      title: 'Public beta next-step readiness',
      ui_anchor: 'betaReadinessGrid',
      local_check: 'npm run check:auth',
      next_review_action: 'Review public beta scope, URL smoke evidence, invite approval phrase, support triage, and no-share/no-invite/no-live-action blocker metadata before founder public beta review.',
      safe_review_router: 'local_ui_navigation_only',
      no_server_storage_attempted: true,
      no_external_export_attempted: true,
      no_live_action_attempted: true,
    ...
    week_two_investor_founder_package_alignment: {
      id: 'week_two_investor_founder_package_alignment_target',
      source_id: 'week_two_investor_founder_package_alignment',
      title: 'Week 2 investor/founder package alignment',
      ui_anchor: 'betaReadinessGrid',
      local_check: 'npm run check:auth',
      next_review_action:
        'Review Week 2 investor/founder packet alignment metadata for live-finance, escrow/token, AI-authority, and external-send claim gates before any investor, grant, provider, attorney, or public packet action.',
      safe_review_router: 'local_ui_navigation_only',
      no_server_storage_attempted: true,
      no_external_export_attempted: true,
      no_live_action_attempted: true,
  ...
  const evidenceSources = [
    ...
    {
      id: 'week_two_deployment_public_beta_readiness',
      title: 'Week 2 deployment/public beta readiness',
      storage_scope: 'server_readonly_metadata',
      export_scope: 'metadata_only',
      allowed_fields: [
        ...metadataAllowlist,
        'source_request_id',
        'deployment_public_beta_checklist_count',
        'readiness_state_counts',
        'checklist_phase_counts',
        'required_evidence_count',
        'founder_report_field_count',
        ...
        'checklist_phase',
        'no_secret_requested',
        'no_external_account_login_attempted',
        'no_external_account_change_attempted',
        'no_deploy_setting_change_attempted',
        'no_dns_change_attempted',
        'no_supabase_redirect_change_attempted',
      ...
      blocked_fields: [
        ...
        'tester_invite_approval',
        'invite_recipient',
        'tester_contact_details',
        'public_beta_launch_approval',
        'public_beta_flip_approval',
        'deploy_approval',
        'production_deploy_approval',
        'payment_data',
        'wallet_data',
      ...
      review_targets: [reviewTargetBySource.week_two_deployment_public_beta_readiness],
    },
    {
      id: 'legal_provider_next_step_readiness',
      title: 'Legal/provider next-step readiness',
      storage_scope: 'server_readonly_metadata',
      export_scope: 'metadata_only',
      allowed_fields: [
    ...
    },
    {
      ...
      review_targets: [reviewTargetBySource.public_beta_next_step_readiness],
    },
    {
    ...
    {
      id: 'week_two_investor_founder_package_alignment',
      title: 'Week 2 investor/founder package alignment',
      storage_scope: 'server_readonly_metadata',
      export_scope: 'metadata_only',
      allowed_fields: [
        ...metadataAllowlist,
        'source_request_id',
        'investor_founder_alignment_count',
        'alignment_state_counts',
        'alignment_area_counts',
        'required_evidence_count',
        'required_evidence',
        'founder_report_field_count',
        'founder_report_fields',
        ...
        'no_secret_requested',
        'no_external_send_attempted',
        'no_investor_outreach_attempted',
        'no_grant_submission_attempted',
        'no_provider_outreach_attempted',
        'no_publication_attempted',
        'no_public_url_share_attempted',
        'no_live_finance_action_attempted',
        'no_public_claim_approval_attempted',
        'no_xpr_signature_attempted',
        'no_fio_registration_attempted',
        'no_legal_provider_decision_attempted',
        'no_production_release_attempted',
        'no_live_action_attempted',
        'raw_content_storage_boundary',
      ...
      blocked_fields: [
        ...
        'xpr_signature_approval',
        'fio_registration',
        'fio_registration_approval',
        'metallicus_partnership_approval',
        'approved_provider_claim',
        'provider_commitment',
        'ai_credit_approval_claim',
        'ai_legal_decision_claim',
      ...
      review_targets: [reviewTargetBySource.week_two_investor_founder_package_alignment],
    },
    {
