...
function buildAdminEvidenceExportPreview(req) {
  ...
  const reviewTargetBySource = {
    ...
    homepage_publication_founder_decision_script: {
      id: 'homepage_publication_founder_decision_script_target',
      source_id: 'homepage_publication_founder_decision_script',
      title: 'Homepage founder decision script',
      ui_anchor: 'betaReadinessGrid',
      local_check: 'npm run check:auth',
      next_review_action: 'Review exact founder decision phrase categories, allowed/not-allowed outcomes, source docs, and no-public/no-deploy/no-share/no-live gates before homepage publication handoff.',
      safe_review_router: 'local_ui_navigation_only',
      no_server_storage_attempted: true,
      no_external_export_attempted: true,
      no_live_action_attempted: true,
  ...
  const evidenceSources = [
    ...
    {
      id: 'homepage_publication_founder_decision_script',
      title: 'Homepage founder decision script',
      storage_scope: 'server_readonly_metadata',
      export_scope: 'metadata_only',
      allowed_fields: [
        ...metadataAllowlist,
        'source_request_id',
        'decision_script_item_count',
        'decision_state_counts',
        'decision_id_count',
        'exact_phrase_count',
        'allowed_outcome_count',
        'not_allowed_outcome_count',
        'source_doc_count',
        'required_before_next_step_values',
        'required_before_next_step_count',
        'no_public_homepage_edit_attempted',
        'no_public_whitepaper_edit_attempted',
        'no_deploy_setting_change_attempted',
        'no_public_url_share_attempted',
      ...
      blocked_fields: [
        ...
        'founder_decision_text',
        'exact_phrase_text',
        'decision_phrase_text',
        'publication_go_approval',
        'publication_go_text',
        'copy_direction_approval',
        'hidden_infrastructure_approval',
        'browser_qa_acceptance_approval',
        'asset_policy_approval',
        'public_replacement_approval',
        'public_file_replacement_approval',
        'public_index_html_replacement_approval',
      ...
      review_targets: [reviewTargetBySource.homepage_publication_founder_decision_script],
    },
    {
